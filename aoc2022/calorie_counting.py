...
class Elf:
    def __init__(self, *calories: int):
        self.food_calories: [int] = list(calories)
        self._total: Optional[int] = None

    @property
    def total(self) -> int:
        if self._total is None:
            self._total = sum(self.food_calories)
        return self._total

    def __str__(self):
        return repr(self.food_calories)

    def __lt__(self, other):
        return isinstance(other, Elf) and self.total < other.total

    def __eq__(self, other):
        return isinstance(other, Elf) and self.food_calories == other.food_calories
